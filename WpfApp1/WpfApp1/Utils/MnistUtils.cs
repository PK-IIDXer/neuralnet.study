...
namespace WpfApp1.Utils
{
    class MnistUtils
    {
        ...
        /// MNISTデータセットのパス
        /// </summary>
        private const string MNIST_FILE_PATH = @"C:\Users\h-saito\Desktop\neuralnet.study\WpfApp1\mnist_dataset\train-images-idx3-ubyte.gz";

        /// <summary>
        /// ラベルファイルのパス
        /// </summary>
        private const string LABEL_FILE_PATH = @"C:\Users\h-saito\Desktop\neuralnet.study\WpfApp1\mnist_dataset\train-labels-idx1-ubyte.gz";
        #endregion

        private MnistImage[] _MnistImages { get; set; }
